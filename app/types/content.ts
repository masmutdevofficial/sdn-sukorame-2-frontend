...
export interface ContentItem { id:string; title:string; slug:string; excerpt:string; body:string; category:string; date:string; status:ContentStatus; icon?:string }
export interface ListQuery { page?:number; perPage?:number; search?:string; status?:ContentStatus; category?:string; sortBy?:string; sortOrder?:'asc'|'desc' }
