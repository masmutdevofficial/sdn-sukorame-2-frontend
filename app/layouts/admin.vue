  ...
  <div class="min-h-screen bg-[#f4f7fa]">
    <aside class="admin-sidebar fixed inset-y-0 left-0 z-40 hidden w-[17.5rem] flex-col text-white md:flex">
      <div class="flex h-20 items-center gap-3 border-b border-white/10 px-5">
        <span class="grid size-12 place-items-center overflow-hidden rounded-2xl bg-white p-1 shadow-lg shadow-slate-950/15"><img src="/logo.png" alt="Logo SDN Sukorame 2" class="size-full object-contain" /></span>
      ...
      <div class="m-4 rounded-2xl border border-white/10 bg-white/[.07] p-3.5">
        <div class="flex items-center gap-3"><span class="grid size-9 place-items-center rounded-xl bg-emerald-400/15 text-emerald-300"><Icon name="mdi:check-decagram-outline" size="20" /></span><div><p class="text-xs font-bold">Sistem siap</p><p class="mt-0.5 text-[10px] text-blue-200">Mode demo aktif</p></div></div>
      </div>
    </aside>
