    ...
    <form v-else class="mt-6 grid gap-6" @submit.prevent="save">
      ...
      <section class="card p-6">
        ...
        <div class="form-grid">
          ...
          <label class="admin-field md:col-span-2">Deskripsi<textarea v-model="form.hero.description" required rows="4" /></label><label class="admin-field">URL gambar<input v-model="form.hero.image" required></label><label class="admin-field">Teks alternatif gambar<input v-model="form.hero.imageAlt" required></label>
